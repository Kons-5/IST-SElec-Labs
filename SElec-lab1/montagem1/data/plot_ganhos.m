...
%% Read the .csv
raw_data1 = readtable("ganhoB.csv", 'VariableNamingRule', 'preserve');
raw_data2 = readtable("ganhoC.csv", 'VariableNamingRule', 'preserve');
...
% left side
yyaxis left; 
p1 = semilogx(raw_data1{:,1}, linear1, 'Color', [0 0 1], 'LineWidth', 1.5); hold on;
p2 = semilogx(raw_data2{:,1}, linear2, 'Color', [1 0 0], 'LineWidth', 1.5); hold on;
...
%% right side
yyaxis right; 
p3 = semilogx(raw_data1{:,1}, angle1, '--', 'Color', [0 0 1], 'LineWidth', 1.5); hold on;
p4 = semilogx(raw_data2{:,1}, angle2, '--', 'Color', [1 0 0], 'LineWidth', 1.5); hold off;
